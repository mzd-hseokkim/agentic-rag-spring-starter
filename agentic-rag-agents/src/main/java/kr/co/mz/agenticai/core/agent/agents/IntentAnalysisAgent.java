...
public final class IntentAnalysisAgent implements Agent {
    ...
    public IntentAnalysisAgent(ChatModel chatModel) {
        this(chatModel, KoreanAgentPrompts.INTENT_CLASSIFY, ObservationRegistry.NOOP);
    }

    public IntentAnalysisAgent(ChatModel chatModel, String promptTemplate) {
        this(chatModel, promptTemplate, ObservationRegistry.NOOP);
    }
    ...
    public void execute(AgentContext context) {
        ...
        Observation obs = RagObservability.start(RagObservability.SPAN_AGENT_PLANNER, observationRegistry);
        try {
